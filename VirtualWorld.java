...
public final class VirtualWorld extends PApplet {
    ...
    */
    ...
    public void mousePressed() {
        ...
        world.getOccupant(pressed).ifPresent(e -> {
            String type = e.getClass().getSimpleName();
            if (e instanceof Tree t) {
                System.out.println(e.getId() + ": " + type + " : " + t.getHealth());
            } else if (e instanceof Sapling s) {
                System.out.println(e.getId() + ": " + type + " : " + s.getHealth());
            } else {
                System.out.println(e.getId() + ": " + type);
            }
        });
    ...
    public void scheduleActions(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
        ...
        for (Entity e : world.getEntities()) {
            ...
            if (e instanceof ActiveEntity) {
                ((ActiveEntity) e).scheduleAction(scheduler, world, imageStore);
            }
            else if (e instanceof AnimatedEntity) {
                ((AnimatedEntity) e).scheduleAnimation(scheduler, world, imageStore);
            }
        }
    }
