...
/**
 * This file contains test cases for the Virtual World. It runs the world as a "headless" process (i.e., without any
 * visible graphics). Each test case sets up a mini Virtual World and then runs the simulation for a specified
 * number of frames.
 */
public class WorldTests {

    /**
     * Create a little VirtualWorld with the specified number of rows and columns, and with the
     * specified entities in it.
     *
     * @param rows The number of rows
     * @param cols The number of columns
     * @param entities The entities that should be present in the world
     * @return A string representation of the VirtualWorld, to be used in the following tests.
     ...
     */
    private static String makeSave(int rows, int cols, String... entities) {
    ...
    public void testFairyAnimation() {
        ...
        assertEquals(1, entities.size(), "Expected the following entity to be present: myfairy 0 0 10");
    ...
    public void testObstacleAnimation() {
        ...
        assertEquals(1, entities.size(), "Expected the following entity to be present: myobstacle 0 0 16");
    ...
    public void testParsing() {
        ...
        assertEquals(0, entities.size(), "Expected no entities to be present");
    ...
    public void testFairyPathing() {
        ...
        assertEquals(1, entities.size(), "Expected the following entity to be present: myfairy 10 11 0");
    ...
    public void testSaplingIntoStump() {
        ...
        assertEquals(1, entities.size(), "Expected the following entity to be present: stump_mysapling 0 0 0");
    ...
    public void testStumpIntoSapling() {
        ...
        assertEquals(1, entities.size(), "Expected the following entity to be present: sapling_mystump (i.e., the stump transformed into a sapling).");
    ...
    public void testStumpIntoSaplingIntoTree() {
        ...
        assertEquals(1, entities.size(), "Expected the following entity to be present: tree_mystump (i.e., the stump transformed into a sapling, then into a tree).");
    ...
    public void testSaplingIntoTree() {
        ...
        assertEquals(1, entities.size(), "Expected the following entity to be present: tree_mysapling (i.e., the sapling transformed into a tree).");
    ...
    public void testTreeIntoStump() {
        ...
        assertEquals(1, entities.size(), "Expected the following entity to be present: stump_mytree (i.e., the tree transformed into a stump).");
    ...
    public void testDudeAnimation() {
        ...
        assertEquals(1, entities.size(), "Expected the following entity to be present: mydude 0 0 100");
    ...
    public void testDudeLimit() {
        ...
        String dudeInfo = entities.stream().filter(s -> s.startsWith("mydude")).findFirst().orElse(null);
        assertEquals("mydude 4 1 0", dudeInfo);
    }
    ...
    public void testDudeTransformNotFull() {
        ...
        assertEquals(1, entities.size(), "Expected the following entity to be present: mydude 3 1 0");
    ...
    public void testDudeTransformFull() {
        ...
        String dudeInfo = entities.stream().filter(s -> s.startsWith("mydude")).findFirst().orElse(null);
        assertEquals("mydude 4 2 0", dudeInfo);
    }
}
